...
- [ ] Re-enable Screen Mirror popout after `2.0.0` stable: keep the current implementation, but finish sizing, centering, focus, and reliability work before restoring the button in the next beta.
